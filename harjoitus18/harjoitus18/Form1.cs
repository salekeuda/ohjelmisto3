...
namespace harjoitus18
{
    public partial class Form1 : Form
    {
        ...
        private void postinumeroLB_Click(object sender, EventArgs e)
        {

        }

        private void osoiteLB_Click(object sender, EventArgs e)
        {
